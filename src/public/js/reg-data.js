...
const enrollType = [
    ...
    // old data
    // { id: 18, title: 'Unskilled migrant workers', value: '18' },
    // { id: 27, title: 'Bangladeshi migrant workers going abroad', value: '27' },
    // {id: 19, title: 'জোরপূর্বক বাস্তুচ্যুত মায়ানমার জনগোষ্ঠী ক্যাম্পে নিয়োজিত স্বাস্থ্য কর্মী', value: '19'},
    // {id: 20, title: 'বয়স্ক ভাতা,  বিধবা ভাতা গ্রহণকারী', value: '20'},
    // {id: 21, title: 'বয়স্ক জনগোষ্ঠী', value: '21'},
    // {id: 22, title: 'অন্যভাবে সক্ষম (বুদ্ধি প্রতিবন্ধী)', value: '22'}
];
...
const professionType_en = [
    { value: '', title: '--select--' },
    { title: 'Judge', value: 'বিচারক' },
    { title: 'Government Service', value: 'সরকারী চাকুরী' },
    { title: 'Private Job', value: 'বেসরকারী চাকুরী' },
    { title: 'Doctor', value: 'ডাক্তার' },
    { title: 'Engineer', value: 'ইঞ্জিনিয়ার' },
    { title: 'Teacher', value: 'শিক্ষক' },
    { title: 'Lawyer', value: 'আইনজীবি' },
    { title: 'Banker', value: 'ব্যাংকার' },
    { title: 'Journalist', value: 'সাংবাদিকতা' },
    { title: 'Agriculturist', value: 'কৃষিবিদ' },
    { title: 'Business', value: 'ব্যবসা' },
    { title: 'Artist', value: 'শিল্পী' },
    { title: 'Retired Government Service Holder', value: 'অবসরপ্রাপ্ত সরকারী চাকুরীজীবী' },
    { title: 'Retired Private Service Holder', value: 'অবসরপ্রাপ্ত বেসরকারী চাকুরীজীবী' },
    { title: 'Imam/Priest', value: 'ইমাম/পুরোহিত/পাদ্রী' },
    { title: 'Singer', value: 'কন্ঠ শিল্পী' },
    { title: 'Labour', value: 'শ্রমিক' },
    { title: 'Farmer', value: 'কৃষক' },
    { title: 'Student', value: 'ছাত্র/ছাত্রী' },
    { title: 'House-wife', value: 'গৃহিনী' },
    { title: 'Day laborer', value: 'দিনমজুর' },
    { title: 'Unemployed', value: 'বেকার' },
    { title: 'House-worker', value: 'গৃহকর্মী' },
    { title: 'Washer', value: 'ধোপা' },
    { title: 'Blacksmith', value: 'কামার' },
    { title: 'Potter', value: 'কুমার' },
    { title: 'Fisherman', value: 'জেলে' },
    { title: 'Mechanic', value: 'মিস্ত্রী' },
    { title: 'Guard', value: 'প্রহরী' },
    { title: 'Weaver', value: 'তাঁতি' },
    { title: 'Cleaner', value: 'পরিচ্ছন্নকর্মী' },
    { title: 'boatman', value: 'মাঝি' },
    { title: 'Coolie', value: 'কুলি' },
    { title: 'Cobbler', value: 'মুচি' },
    { title: 'Chef', value: 'বাবুর্চী' },
    { title: 'Hawker', value: 'হকার' },
    { title: 'Richshaw/Van Puller', value: 'রিক্সা/ভ্যান চালক' },
    { title: 'barber', value: 'নাপিত' },
    { title: 'Taylor', value: 'দর্জি' },
    { title: 'Contractor', value: 'কন্ট্রাক্টর' },
    { title: 'Driver', value: 'ড্রাইভার' },
    { title: 'Care-giver', value: 'সেবিকা' },
    { title: 'Kabiraj', value: 'হেকিম/কবিরাজ' },
    { title: 'Butcher', value: 'কসাই' },
    { title: 'Gardener', value: 'মালি' },
    { title: 'Others', value: 'অন্যান্য' }
];
...
for (let i = current_date.getFullYear(); i >= 1900; i--) {
    years_en.push(
        { value: `${i}`, title: `${i}` }
    );
}
...
const Countries = [
    ...
    { value: "2", title: "United Kingdom" },
    { value: "3", title: "Canada" },
];




const birthYears_birth_reg_en = [];
let year_birth_reg = d.getFullYear() - 12;

for (let i = year_birth_reg; i >= 1900; i--) {
    birthYears_birth_reg_en.push({
        value: `${i}`, title: `${i}`
    });
}
